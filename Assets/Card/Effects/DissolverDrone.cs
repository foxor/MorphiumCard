...
public class DissolverDrone : Effect {
    ...
    {
        Minion lab = GameState.SummonMinion(guid, Attack(), Durability(), Name, new MinionBuilder() {
            Hazmat = true
        });
